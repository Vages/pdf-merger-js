...
import { P as PDFMerger, p as parsePagesString } from './index-heJLtRbU.mjs';
import 'fs/promises';
import 'pdf-lib';

function main(packageJson) {
  program.version(packageJson.version).description(packageJson.description).option("-o, --output <outputFile>", "Merged PDF output file path").option("-v, --verbose", "Print verbose output").option("-s, --silent", "do not print any output to stdout. Overwrites --verbose").arguments("<inputFiles...>").action(async (inputFiles, cmd) => {
